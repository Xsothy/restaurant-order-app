    ...
    (handler) =>
        Effect.gen(function* () {
            ...
            return handler
                ...
                .handle("createCategory", ({ payload: { name } }) => categoriesRepo
                    .where({
                        column: "name",
                        value: name
                    })
                ...
                .handle("updateCategory", ({ path: { id }, payload }) => categoriesRepo.updateCategory(id, payload.name))
