...
export declare const TodoIdFromString: Schema.SchemaClass<number & import("effect/Brand").Brand<"TodoId">, string, never>;
...
declare const TodosApi_base: HttpApi.HttpApi<"todos", typeof TodosApiGroup, import("@effect/platform/HttpApiError").HttpApiDecodeError, never>;
